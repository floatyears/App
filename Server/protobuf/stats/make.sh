...
sed -n '/Code generated by protoc-gen-go./,/import math "math"/p' stats_all.pb.go > tmp.go
echo 'import . "bbproto"' >> tmp.go
echo '' >> tmp.go
sed -n '/\/\/ Reference proto, json, and math imports to suppress error if they are not otherwise used./,/var _ = math.Inf/p' stats_all.pb.go >> tmp.go
echo '' >> tmp.go
