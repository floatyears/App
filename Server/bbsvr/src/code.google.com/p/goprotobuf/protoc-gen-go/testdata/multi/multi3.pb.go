...
type Multi3 struct {
	HatType          *Multi3_HatType `protobuf:"varint,1,opt,name=hat_type,enum=multi.Multi3_HatType" json:"hat_type,omitempty"`
...
func init() {
	proto.RegisterEnum("multi.Multi3_HatType", Multi3_HatType_name, Multi3_HatType_value)
}
