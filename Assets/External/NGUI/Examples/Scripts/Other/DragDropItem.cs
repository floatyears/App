...
public class DragDropItem : MonoBehaviour
{
	...
	{
		LogHelper.LogError("OnDrag:" + gameObject.name);
	...
	{
		LogHelper.LogError(isOver + "``onhover``"+gameObject.name);
	}

	void OnPress (bool isPressed)
	{
		LogHelper.LogError("OnPress:"+gameObject.name);
		if (enabled)
		{
			if (isPressed)
			{
