...
//    }
	...
	{
		Debug.Log("TFriendList () inst is " + inst);
...
//                return;
	...
	{
		Debug.LogError("assignFriend(), friend count " + instance.friend.Count);

		if (friend != null)
		{
			friend.Clear();
			Debug.LogError("cleared(), friend count " + instance.friend.Count);
