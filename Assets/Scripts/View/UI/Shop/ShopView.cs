...
//		}
	...
	private void CreateDragView(){
		...
		if (DataCenter.Instance.AccountInfo.PayTotal == 0) {
			friendOutDataList.Add (new ShopItemData ("1.99",ShopItemEnum.Stone,120,"ms.chip.pack1"));
			friendOutDataList.Add (new ShopItemData ("4.99",ShopItemEnum.Stone,300,"ms.chip.pack2"));
			friendOutDataList.Add (new ShopItemData ("9.99",ShopItemEnum.Stone,600,"ms.chip.pack3"));
			friendOutDataList.Add (new ShopItemData ("19.99",ShopItemEnum.Stone,1200,"ms.chip.pack4"));
			friendOutDataList.Add (new ShopItemData ("49.99",ShopItemEnum.Stone,3000,"ms.chip.pack5"));
			friendOutDataList.Add (new ShopItemData ("99.99",ShopItemEnum.Stone,6000,"ms.chip.pack6"));
		} else {
			friendOutDataList.Add (new ShopItemData ("1.99",ShopItemEnum.Stone,120,"ms.chip2.pack1"));
			friendOutDataList.Add (new ShopItemData ("4.99",ShopItemEnum.Stone,300,"ms.chip2.pack2"));
			friendOutDataList.Add (new ShopItemData ("9.99",ShopItemEnum.Stone,600,"ms.chip2.pack3"));
			friendOutDataList.Add (new ShopItemData ("19.99",ShopItemEnum.Stone,1200,"ms.chip2.pack4"));
			friendOutDataList.Add (new ShopItemData ("49.99",ShopItemEnum.Stone,3000,"ms.chip2.pack5"));
			friendOutDataList.Add (new ShopItemData ("99.99",ShopItemEnum.Stone,6000,"ms.chip2.pack6"));
		}
