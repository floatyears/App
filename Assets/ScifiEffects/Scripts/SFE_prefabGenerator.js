...
var generateOneInstantly:boolean=false;
...
timeCounter+=Time.deltaTime;
	...
	if (generateOneInstantly==true)
		{
 		timeCounter=trigger;
		generateOneInstantly=false;
		}
    ...
    function OnDrawGizmosSelected () {
        ...
        Gizmos.DrawCube (transform.position, Vector3 (xWidth, yWidth, zWidth));
if (xWidth==0 && yWidth==0 && zWidth==0) Gizmos.DrawSphere (transform.position, 0.5);
