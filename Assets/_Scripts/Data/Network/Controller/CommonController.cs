...
public class CommonController : ControllerBase {
	...
	public void GetServerTime(NetCallback callBack, uint questid, bool gameover=false) {
		...
		reqGetServerTime.header.userId = DataCenter.Instance.UserData.UserInfo.userId;
	...
	public void UploadStat(NetCallback callBack, List<EventData> events) {
		...
		reqUploadStat.header.userId = DataCenter.Instance.UserData.UserInfo != null ? DataCenter.Instance.UserData.UserInfo.userId : 0;
