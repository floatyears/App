...
public class AudioManager {
	...
	private AudioManager(){
		Debug.Log ("data store: " + GameDataPersistence.Instance.GetIntDataNoEncypt (soundName));
		isCloseSound = GameDataPersistence.Instance.GetIntDataNoEncypt (soundName)  == 0 ? false : true;
		isCloseBackground = GameDataPersistence.Instance.GetIntDataNoEncypt (bgmName) == 0 ? false : true;
	}
